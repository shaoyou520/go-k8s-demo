...
import (
	"context"
	mycontrollerv1 "my-crd/api/mycontroller/v1"
	versioned "my-crd/client/clientset/versioned"
	internalinterfaces "my-crd/client/informers/externalversions/internalinterfaces"
	v1 "my-crd/client/listers/mycontroller/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MycontrollerV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MycontrollerV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&mycontrollerv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mycontrollerv1.Foo{}, f.defaultInformer)
}
