...
// +kubebuilder:webhook:path=/mutate-k8s-qt-qt-domain-v1-app,mutating=true,failurePolicy=fail,sideEffects=None,groups=k8s.qt.qt.domain,resources=apps,verbs=create;update,versions=v1,name=mapp.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-k8s-qt-qt-domain-v1-app,mutating=false,failurePolicy=fail,sideEffects=None,groups=k8s.qt.qt.domain,resources=apps,verbs=create;update,versions=v1,name=vapp.kb.io,admissionReviewVersions=v1
