...
import (
	...
	"qt.doamin/App/internal/controller"
...
func init() {
	...
	utilruntime.Must(k8sqtv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "aec47bee.qt.domain",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&k8sqtv1.App{}).SetupWebhookWithManager(mgr); err != nil {
